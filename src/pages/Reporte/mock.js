  ...
  apex: {
    column: {
      series: [{
        ...
        //   (function (){
        //   var data = [];
        //   axios.get('http://62.171.155.168:9000/rest-api/expediente/dashboard_expediente')
        //   .then( (response) =>{
        //     response.data.barras.forEach(
        //       e=>{
        //         data.push(Number(e.n_cantidad_exp))
        //       }
        //     );
        //     return data;
        //   })
      ...
      options: {
        ...
        xaxis: {
          categories: ['Direccion', 'Energia', 'Hidrocarburo', 'Historico','Legal','Mesa de partes','Mineria'],
          labels: {
            style: {
              colors: columnColors,
              fontSize: '14px'
    ...
    pie: {
      ...
      options: {
        labels: ["Aprobado", "Asignado", "Historico","Observado","Sin Asignar"],
        // theme: {
        //   monochrome: {
        //     enabled: true,
        //     color: primary,
      ...
      xAxis: [
        ...
        },
        {
          ...
          axisPointer: {
            label: {
              formatter: function (params) {
                return 'Documentos  ' + params.value
                  + (params.seriesData.length ? '：' + params.seriesData[0].data : '');
              }
            }
          },
